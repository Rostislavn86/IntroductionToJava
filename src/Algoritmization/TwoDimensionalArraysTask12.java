...
public class TwoDimensionalArraysTask12
{
    public static void main(String[] args)
    {
        ...
        System.out.println("**********Отсортированные строки матрицы по возростанию **************");
        ...
        System.out.println("**********Отсортированные строки матрицы по убыванию **************");
